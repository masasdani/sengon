 ...
 * @see Apache Open NLP 
 */
public class PartOfSpeechEn implements PartOfSpeech {
	
	public static final String POS_MODEL_URL = "en_pos_maxent.bin";
	
	/**
	 * @see ApacheOpenNLP Part Of Speech
	 */
	POSModel model;
	 ...
	 * @param modelURL
	 */
	public PartOfSpeechEn(String modelURL) {
	 ...
	 * @param inputStream
	 */
	public PartOfSpeechEn(InputStream inputStream) {
